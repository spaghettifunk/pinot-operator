...
| *`items`* __xref:{anchor_prefix}-github-com-spaghettifunk-pinot-operator-api-v1alpha1-pinot[$$Pinot$$]__ | Array of Pinot resources.
|===
...
|===
| Field | Description
| *`foo`* __string__ | Foo is an example field of Tenant. Edit Tenant_types.go to remove/update
|===
