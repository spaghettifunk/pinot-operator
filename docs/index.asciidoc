...
[id="{anchor_prefix}-github-com-spaghettifunk-pinot-operator-api-pinot-v1alpha1-schemalist"]
==== SchemaList 
...
| *`items`* __xref:{anchor_prefix}-github-com-spaghettifunk-pinot-operator-api-pinot-v1alpha1-schema[$$Schema$$]__ | 
|===
...
|===
| Field | Description
| *`foo`* __string__ | Foo is an example field of Schema. Edit Schema_types.go to remove/update
|===
