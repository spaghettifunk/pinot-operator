...
const (
	...
	statefulsetName        = "pinot-broker"
	configmapName          = "pinot-broker-config"
	serviceName            = "pinot-broker"
	serviceHeadlessName    = "pinot-broker-headless"
	serviceExternalName    = "pinot-broker-external"
	brokerDataVolumeName   = "pinot-broker-data"
	brokerConfigVolumeName = "pinot-broker-config"
)
